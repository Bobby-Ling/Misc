...
-- Table `rbac`.`aprole`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rbac`.`aprole` ;
...
-- Table `rbac`.`apuser`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rbac`.`apuser` ;
...
-- Table `rbac`.`apgroup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rbac`.`apgroup` ;
...
-- Table `rbac`.`apmodule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rbac`.`apmodule` ;
...
-- Table `rbac`.`apright`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rbac`.`apright` ;
