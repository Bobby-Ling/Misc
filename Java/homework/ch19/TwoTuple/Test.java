...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        //sort方法是根据元素的compareTo方法结果进行排序，测试compareTo方法是否实现正确
        ...
        TwoTuple<TwoTuple<Integer, String>, TwoTuple<Integer, String>> tt1 =
                new TwoTuple<>(new TwoTuple<Integer, String>(1, "aaa"), new TwoTuple<Integer, String>(1, "bbb"));
        TwoTuple<TwoTuple<Integer, String>, TwoTuple<Integer, String>> tt2 =
                new TwoTuple<>(new TwoTuple<Integer, String>(1, "aaa"), new TwoTuple<Integer, String>(2, "bbb"));
